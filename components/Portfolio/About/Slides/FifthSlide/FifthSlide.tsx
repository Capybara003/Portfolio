    ...
    <Slide bgColor={'#010606'} height={'100vh'} anchorID={'fifth-slide'}>
      <Styled.FifthSlide>
        ...
        <Styled.Milestone variant={'third'}>
          ...
          <h4>Taras Shevchenko National University of Kyiv</h4>
          <PortfolioParagraph
            margin={'1rem 0'}
            paragraphText={
              'I worked at Taras Shevchenko National University of Kyiv on a number of educational and Web projects as a front and back end developer. I architected and constructed solutions daily used by tens of thousands of students and thousands of employees.'
            }
            withDarkColor={false}
            variant={'medium'}
            withAnimatedPresence={true}
