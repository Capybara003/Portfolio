...
export const useHighlightedProjectsData = (): {
  ...
  const highlightedProjects: IHighlightedProject[] = [
    ...
    },
    {
      ...
      projectDescription: `A sneak peak of a project that I'm currently building. This is a full-stack portal with 70+ pages designed and built for the department of Optics (Taras Shevchenko National University of Kyiv). It is powered by Next.js and Node.js on backend.`,
      slideHeight: '100vh',
