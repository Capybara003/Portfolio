  ...
  const recommendedFiles: IRecommendedFile[] = [
    {
      ...
      action: () => window.open('https://www.linkedin.com/in/Joshua-kriuchko-a3395234b/', '_blank'),
    ...
    },
    {
      ...
      action: () => router.push('https://Joshua-kriuchko-portfolio.vercel.app/'),
      iconSize: { height: 40, width: 40 },
      willOpenWindowWith: null,
    },
    {
    ...
    },
    {
      ...
      action: () => window.open('https://twitter.com/Joshua_kriu', '_blank'),
      iconSize: { height: 40, width: 40 },
      willOpenWindowWith: null,
    },
    {
